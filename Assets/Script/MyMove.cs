...
namespace UnityEngine.XR.Interaction.Toolkit.Samples.StarterAssets
{
    ...
    /// </summary>
    public class MyMove : ActionBasedContinuousMoveProvider
    {
        ...
        protected override Vector3 ComputeDesiredMove(Vector2 input)
        {
            ...
            combinedPosition.x = m_CombinedTransform.position.x;
            combinedPosition.y = m_CombinedTransform.position.y;
